exports.contactResolvedEmail = (caseId, name, subject) => {
  return `<!DOCTYPE html>
        <html lang="en">
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p>Hi ${name},</p>
                    <p>We’re happy to inform you that your contact request with the subject "<strong>${subject}</strong>" and case ID <strong>${caseId}</strong> has been resolved. We hope the resolution meets your expectations.</p>
